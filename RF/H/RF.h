...
#define RF_Read_TIM_1 htim1 // 用于计时

#define RF_Read_GPIO_Group GPIOB    // 外部中断的GPIO组
...
1.GPIO
    推挽/开漏上拉 输出
 */
#define RF_Write_GPIO_Group GPIOB    // 输出的GPIO组
#define RF_Write_GPIO_Pin GPIO_PIN_0 // 输出的端口号
